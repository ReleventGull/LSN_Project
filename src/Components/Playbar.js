...
const Playbar = ({trackLiked, setCurrentSongMs, navigatingSong, isPlaying, deviceVolume, setDeviceVolume, songPlaying, player, setIsPlaying, isPlayingRef, songMs, currentSongMs}) => {
    const onToggle = () => {
        player.togglePlay()
    }
                        ...
                        <div className="grid grid-cols-[auto_2fr] items-center">
                            ...
                            <div className="flex flex-row items-center">
                                ...
                                <div>
                                    {
                                        trackLiked === false ? 
                                        <svg className="likeSongIcon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        :
                                        <svg className="songLikedIcon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
